...
if not exist "MU310-Q612EB_V1.1.0.0_1_modem.bin" (
    echo [ERROR] Firmware file not found: MU310-Q612EB_V1.1.0.0_1_modem.bin
...
adb push "MU310-Q612EB_V1.1.0.0_1_modem.bin" /usrdata/cache/ufs/update.zip
if %errorlevel% neq 0 (
